...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
double compute(DrawableTrimesh<> &m, DrawableTrimesh<> &grid,const int method,const double a, const double b,const double c,const int tri_type, const int N, ScalarField &F,const double anisotropy,int without_boundary,int mode,int noise,int k)
{
    ...
    F=get_scalar_field(m,a,b,c,Eggs,noise,k);
    V=compute_field(m,F,method);


    bring_the_field_inside(m,grid,V,Vgrid,method);

    double err=estimate_error(GT,Vgrid,grid,method,without_boundary,mode);
        ...
        if(sweep)
        {
...

            {
                ...
                for(int i=0;i<anis[2]+1;++i)
                {
                    ...
                    make_triangulation(m,2,N,anis[0]+delta_anis*i);
