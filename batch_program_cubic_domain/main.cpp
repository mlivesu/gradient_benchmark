...
//                make_tet_mesh(m,N,v);
    ...
    case 3:
    {
        ...
        {
            std::ofstream outfile;
            outfile.open("/Users/Dala/Documents/MATLAB/Gradient_fields/ProfilingOnCUBESof"+ method_names[method] +" .csv");
            ...
            for(int i=0;i<6;++i)
            {
                ...
                //{
                std::vector<double> areas(m.num_faces());
                for(int k=0;k<m.num_faces();++k)
                {
                    areas[k]=m.face_area(k);
                }
                std::chrono::high_resolution_clock::time_point t1 = std::chrono::high_resolution_clock::now();

                DrawableVectorField V=compute_field(m,f,method,0);
                ...
                //                    Eigen::SparseMatrix<double> G=GG_gradient_matrix(m,true);
            ...
            std::cout<<"FINISH WITG"<<method_names[method]<<std::endl;
        }
        std::cout<<"FINISH"<<std::endl;
