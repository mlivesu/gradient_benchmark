...
*     Italy                                                                      *
**********************************************************************************/
#ifndef CINO_GG_GRADIENT_H
#define CINO_GG_GRADIENT_H
...
CINO_INLINE
Eigen::SparseMatrix<double> GG_gradient_matrix(const AbstractPolygonMesh<M,V,E,P> & m, int mode=0);
